...
UPDATE "Field"
SET
  "secondaryId" = gen_random_uuid ()::TEXT
WHERE
  "secondaryId" IS NULL;

-- Restrict the Field to required
ALTER TABLE "Field"
ALTER COLUMN "secondaryId"
SET NOT NULL;
...
ADD CONSTRAINT "DocumentAuditLog_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "Document" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
