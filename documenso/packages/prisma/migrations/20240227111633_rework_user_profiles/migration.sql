...
-- DropForeignKey
ALTER TABLE "User"
DROP CONSTRAINT "User_profileURL_fkey";
...
DROP CONSTRAINT "UserProfile_pkey",
...
-- AddForeignKey
ALTER TABLE "UserProfile"
ADD CONSTRAINT "UserProfile_id_fkey" FOREIGN KEY ("id") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
